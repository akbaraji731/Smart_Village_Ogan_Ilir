...
import com.smartvillageoi.clientapp.adapter.ProductLoadMoreAdapter;
import com.smartvillageoi.clientapp.adapter.SubCategoryAdapter;
import com.smartvillageoi.clientapp.helper.ApiConfig;
import com.smartvillageoi.clientapp.helper.Constant;
import com.smartvillageoi.clientapp.helper.GPSTracker;
import com.smartvillageoi.clientapp.helper.Session;
import com.smartvillageoi.clientapp.model.Category;
                    ...
                    if (!jsonObject1.getBoolean(Constant.ERROR)) {
                        ...
                        try {
                            for (int i = 0; i < jsonArray.length(); i++) {
                                ...
                                product.setDistance(GPSTracker.getDistanceInKm(latLng, new LatLng(product.getLatitude(), product.getLongitude())));
