...
public class Constant {
    //MODIFICATION PART
    public static final String MainBaseURL = "https://dashboard.smartvillagedev.com/"; //Admin panel url

    public static final String WebsiteUrl = "https://smartvillagedev.com/";

    //set your jwt secret key here...key must same in PHP and Android
    public static final String JWT_KEY = "polsri_smart_village_commerce";
