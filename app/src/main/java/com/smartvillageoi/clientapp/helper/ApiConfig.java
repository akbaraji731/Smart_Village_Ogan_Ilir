...
import com.smartvillageoi.clientapp.helper.album.AlbumConfig;
            ...
            if (result) {
                try {
                    ...
                    if (!jsonObject.getBoolean(Constant.ERROR)) {
                        ...
                        session.setData(Constant.current_date,strDate );
                        String maxItemInCart = object.getString(Constant.max_cart_items_count);
